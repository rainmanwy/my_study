...
//        try {
//            Enumeration<URL> urls = getClassLoader().getResources("com.github.rainmanwy.smart".replace(".", "/"));
//            while (urls.hasMoreElements()) {
//                URL url = urls.nextElement();
...
//            e.printStackTrace();
//        }
        Set<Class<?>> results =  getClassSet("com.github.rainmanwy.smart");
        Object[] classes = results.toArray();
